...
class ListModel(models.Model):
    ...
    sync_message = models.CharField(max_length=255, verbose_name="Sync Message")
    sync_time = models.DateTimeField(auto_now=False, blank=False, null=False, verbose_name="Sync Time")
